...
Layer Note の current release-driven development で使用する Operating Model を定義します。
...
- CEP / React + TypeScript / ExtendScript bridge / Vite の現在の構成を project evidence として扱う。
- package manager や build/release procedure は repository-controlled docs/scripts が authority であり、この PR では置換しない。
